...
class TestBooksCollector:
    ...
    def test_books_for_children_no_adult_genre(self):
        ...
        for book in children_books:
            ...
            assert book_genre not in collector.genre_age_rating
    ...
    def test_add_new_book_without_genre(self):
        ...
        book_genre = collector.get_book_genre('Некий тестовый том')
    ...
    def test_delete_book_from_favorites(self, books_in_favorites, book_to_delete, expected_favorites):
